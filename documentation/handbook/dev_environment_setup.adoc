...
[#img-inst-customisation,reftext='{figure-caption} {counter:refnum}']
...
. On the add sources step, click add files and navigate to where you cloned the repository, add all files from the link:https://github.com/Zachary-Pearce/POM8/tree/main/rtl[rtl folder], including those in the "packages" and "primitives" sub-folders. The final list should look like the one shown in <<#final-sources>>.

.Final List of Added Sources
[#final-sources,reftext='{figure-caption} {counter:refnum}']
...
.. Go to the source window in the top left, right click on "Simulation Sources" and select "Add Sources."
